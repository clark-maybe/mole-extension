...
1. Go to the [Download](/en/download) page and download the latest release
...
See the [Development Guide](/en/guide/development) for instructions on building from the repository.
:::
...
- [Your First Task](/en/guide/first-task) — A guided walkthrough
- [What Can Mole Do?](/en/guide/examples) — Browse use cases and examples
- [Record a Workflow](/en/guide/workflows) — Teach Mole to repeat tasks for you
- [Configuration Details](/en/guide/configuration) — Advanced settings
